...
const Resources = () => {
  ...
  const [selectedBoard, setSelectedBoard] = useState(null); // Removed TypeScript type annotation

  const handleBoardSelect = (board) => {
    setSelectedBoard(board); // Removed TypeScript type annotation
  };
        ...
        <div className="max-w-md w-full bg-white rounded-lg shadow-xl overflow-hidden">
          <div className="p-8">
            ...
            <div className="mt-8 flex justify-between">
              ...
              <Button
                className={`px-6 bg-purple-700 hover:bg-purple-800 transition-colors ${
