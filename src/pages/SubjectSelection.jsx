...
const SubjectSelection = () => {
  ...
  const { board = "CBSE", grade = "8" } = location.state || {};
        ...
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {subjects.map((subject) => (
              <div
                key={subject.id}
                className="bg-white rounded-lg shadow-lg overflow-hidden transform transition-all duration-300 hover:shadow-xl hover:translate-y-[-4px]"
              >
                  ...
                  {subject.books.map((book) => (
                    ...
                    >
                      <div className="flex items-start">
                        <div className="bg-gray-100 p-2 rounded-lg mr-3">{book.icon}</div>
                                ...
                                <div className="flex justify-between space-x-4">
                                  <div>
                                    ...
                                    <p className="text-sm text-gray-600">
                                      Our interactive reader lets you access materials without
                                      downloading. Take notes, highlight text, and track your progress.
                                    </p>
                                  </div>
