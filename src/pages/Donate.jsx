...
const Donate = () => {
  ...
  const handlePresetAmount = (value) => { // Removed type annotation
    setAmount(value);
    setCustomAmount('');
  };

  const handleCustomAmountChange = (e) => { // Removed type annotation
    setCustomAmount(e.target.value);
    setAmount('');
  };

  const handleSubscribe = (e) => { // Removed type annotation
    e.preventDefault();
    toast({
